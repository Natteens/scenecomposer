...
namespace SceneComposer
{
    public class SceneGroupManager
    {
        ...
        public async Task UnloadScenes()
        {
            ...
            // Unload all additive scenes except Bootstrapper.
            // Do NOT skip based on the current active scene — it may belong to the group
            // being replaced and must be unloaded too. SetActiveScene runs after LoadScenes.
